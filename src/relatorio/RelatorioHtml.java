...
import exception.RelatorioException;
	...
	public class RelatorioHtml {
		...
		private String caminhoRelatorioHTML;

	    public RelatorioHtml() {
	    }

	    public RelatorioHtml(String pathRelatorioHTML) {
	        this.caminhoRelatorioHTML = pathRelatorioHTML;
	    }
	    
	    /**
	     * Metodo responsavel pelo preenchimento do relatorio, 
	     * a partir do arquivo jasper compilado, do nome do arquivo html, 
	     * e considerando os dados sob a forma de List e os parâmetros 
	     * 
	     * @param nomeArquivo
	    ...
	    public void download(String nomeArquivo, InputStream streamRelatorio, Map parametros, List dados) throws RelatorioException {
	        ...
	        try {
	            ...
	            //Ponto onde o relatório com os dados montados é exportado para o formato HTML
				...
				htmlExporter.setParameter(JRHtmlExporterParameter.IMAGES_URI, "/prototipo/image?image=");
