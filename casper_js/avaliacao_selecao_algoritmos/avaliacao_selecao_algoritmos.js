var nome_tela_testada = "avaliacao-selecacao_algoritmos";
...
casper.then(function(){
    ...
    this.capture('casper_js/' + nome_tela_testada+ '1.jpg', undefined, {
        format: 'jpg',
        quality: 75
    });
});
...
casper.then(function(){
    this.wait(2000);
    this.capture('casper_js/' + nome_tela_testada + '2.jpg', 
      {
        top: 0,
        left:0,
        width: 1280,
...
casper.thenOpen('http://localhost:8080/quiron/atendimento/list.faces', function() {
    this.wait(1000);
    this.capture('casper_js/' + nome_tela_testada + '3.jpg', 
      {
        top: 0,
        left:0,
        width: 1280,
...
//clica em ok, para fazer login
casper.thenClick(x('//*[@name="j_id55:tabelaAtendimento:0:j_id102"]'), function(){
 //não faz nada nesse momento.
});

//tira um print da tela de seleção de algoritmo
casper.then(function(){
    this.wait(1000);
    this.capture('casper_js/' + nome_tela_testada + '4.jpg', 
      {
        top: 0,
        left:0,
        width: 1280,
